  ...
  return (
    <div className='bg-accent h-full flex flex-col justify-evenly items-center'>
      ...
      <div className='flex flex-col gap-4'>
        {/* if user is not logged in guest button will show up */}
        {/* <button onClick={()=>ShowPopUp("askName")} className='btn btn-wide btn-primary font-bold text-lg tracking-wider	'>
