  ...
  return (
    <div className='bg-black/20 h-full flex flex-col justify-evenly items-center'>
      ...
      <div className='flex flex-col justify-evenly items-center'>
        ...
        <h1 className='text-4xl font-extrabold font-bungee text-black'>OBJECT HUNT <button onClick={()=>speak("hello")}>Sp</button></h1>
      </div>
      <div className='flex flex-col gap-4'>
        ...
        <button className='btn btn-wide btn-error text-white font-medium text-lg tracking-wider	' onClick={()=> ShowPopUp("howtoplay")}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
